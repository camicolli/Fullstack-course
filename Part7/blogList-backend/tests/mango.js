...
//const url =
//  `mongodb+srv://cocacoca:${password}@cluster0.6tfkr.mongodb.net/BlogList?retryWrites=true&w=majority`
console.log('trying to connect')
const url = `mongodb+srv://cocacoca:${password}@bloglist.qoggu.mongodb.net/database?retryWrites=true&w=majority`
mongoose
